<%@ Page Title="Convite" Language="C#" MasterPageFile="~/Convite.master" AutoEventWireup="true" CodeFile="enviar_convite.aspx.cs" Inherits="convite" %>
                               ...
                               <tr>
                                   ...
                                   <td>
                                       <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" 
                                           SelectMethod="consultaConviteClienteUsuario"  TypeName="Servico" 
                               ...
                               <tr>
                                  <td align="center" colspan="3">
                                     <asp:Button ID="btnEnvia" runat="server" CssClass="edit" 
                                           Text="Envia Convite" Width="150px" onclick="btnEnvia_Click" />
                                  </td>
